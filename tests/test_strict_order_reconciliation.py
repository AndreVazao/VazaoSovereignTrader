...
def _strict_reconciliation_engine(exchange):
    engine = object.__new__(SovereignEngine)
    engine.state = RuntimeState(
        pending_orders={
            "order-strict": {
                "exchange": "binance", "symbol": "BTC/USDT", "side": "buy",
                "requested_qty": 1.0, "known_filled_qty": 0.0, "known_fee": 0.0,
                "known_fill_price": 100.0, "client_order_id": "vzt-strict",
                "created_ts": 123.0, "stop_pct": 0.02, "take_profit_pct": 0.04,
            }
        }
    )
...
def test_reconciliation_blocks_exchange_overfill():
    class Exchange:
        ...
        def fetch_order(self, order_id, symbol):
            return {
                "id": order_id, "symbol": symbol, "side": "buy", "status": "closed",
                "filled": 1.1, "average": 100.0, "clientOrderId": "vzt-strict",
            }

    engine = _strict_reconciliation_engine(Exchange())
    engine._reconcile_pending_orders()
...
def test_reconciliation_blocks_fill_regression():
    class Exchange:
        ...
        def fetch_order(self, order_id, symbol):
            return {
                "id": order_id, "symbol": symbol, "side": "buy", "status": "closed",
                "filled": 0.4, "average": 100.0, "clientOrderId": "vzt-strict",
            }
...
def test_reconciliation_blocks_returned_side_mismatch():
    class Exchange:
        ...
        def fetch_order(self, order_id, symbol):
            return {
                "id": order_id, "symbol": symbol, "side": "sell", "status": "closed",
                "filled": 1.0, "average": 100.0, "clientOrderId": "vzt-strict",
            }
