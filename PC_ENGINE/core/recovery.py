...
class RecoveryManager:
    ...
    def save_positions(self, positions: Dict, pending_orders: Dict | None = None, order_guards: Dict[str, float] | None = None) -> None:
        payload = {
            "ts": int(time.time()),
    ...
    def load_state(self) -> Dict:
        if not self.state_path.exists():
            return {"positions": {}, "pending_orders": {}, "order_guards": {}}
        try:
